...
Always gonna make you cry ");
        ...
        if(BB < 2) {
            alert("Crashing...");
            var i = 0; while (i < 999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999) { window.location.reload(true); i = i - 1 };
        }
    }  
}, 1000);}
